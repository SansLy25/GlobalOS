        ...
        return (
            <aside className="bg-white p-6 rounded-lg shadow-md md:shadow-none md:w-72 lg:w-80 hidden md:block">
                <div className="flex flex-column justify-between mb-2">
                    <div><h3 className="text-sm font-medium text-neutral-700">Масштаб</h3></div>
                    <div>
                        <button onClick={() => setInfoIsEnabled(!infoIsEnabled)}><Info width="17px"
                                                                                       className={infoIsEnabled ? "text-blue-500" : "text-neutral-500"}/>
                        </button>
                    </div>
                </div>
                { !infoIsEnabled ?
